...
(function (global, factory) {
  ...
  function makeReactive(obj) {
    ...
    Object.defineProperty(obj, '__proto__', {
      ...
      set: function set(value) {
        Object.setPrototypeOf(proto, value);
      }
    });
  }

  var Dom7 = function Dom7(items) {
  ...
  Object.getOwnPropertyNames(Array.prototype).forEach(function (k) {
    return k !== 'constructor' && (Dom7.prototype[k] = Array.prototype[k]);
  });
  ...
  function transform(transform) {
    for (var i = 0; i < this.length; i += 1) {
      this[i].style.webkitTransform = this[i].style.transform = transform;
  ...
  function transition(duration) {
    for (var i = 0; i < this.length; i += 1) {
      this[i].style.webkitTransitionDuration = this[i].style.transitionDuration = typeof duration !== 'string' ? "".concat(duration, "ms") : duration;
    }
